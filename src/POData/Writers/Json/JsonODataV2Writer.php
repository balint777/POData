...
class JsonODataV2Writer extends JsonODataV1Writer
{
    ...
    public function canHandle(Version $responseVersion, $contentType)
    {
        ...
        if ($responseVersion == Version::v3()) {
            return in_array(MimeTypes::MIME_APPLICATION_JSON, $parts) && (in_array('odata=verbose', $parts)/* || in_array('odata=minimalmetadata', $parts) // this caused an issue with d: top level element */);
        }
